        ...
        content: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 12),
              const Text(
                'Digit-by-Digit (for meter readings):',
                style: TextStyle(fontWeight: FontWeight.w600),
              ),
              const SizedBox(height: 4),
              const Text('"Total time start 0 5 2 3 6 decimal 8"'),
              const SizedBox(height: 2),
              const Text('  → reads as: 5236.8', style: TextStyle(fontSize: 12, fontStyle: FontStyle.italic)),
              const SizedBox(height: 4),
              const Text('"Tach start 8 5 5 2 point 3"'),
              const SizedBox(height: 2),
              const Text('  → reads as: 8552.3', style: TextStyle(fontSize: 12, fontStyle: FontStyle.italic)),
              const SizedBox(height: 12),
              const Text(
                'Multiple Fields:',
                style: TextStyle(fontWeight: FontWeight.w600),
